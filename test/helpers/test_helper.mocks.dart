...
// in bloc_clean_tests/test/helpers/test_helper.dart.
...
import 'package:bloc_clean_tests/core/error/failure.dart' as _i7;
import 'package:bloc_clean_tests/data/data_sources/remote_data_source.dart'
    as _i9;
import 'package:bloc_clean_tests/data/models/weather_model.dart' as _i3;
import 'package:bloc_clean_tests/domain/entities/weather_entity.dart' as _i8;
import 'package:bloc_clean_tests/domain/repo/weather_repo.dart' as _i4;
...
class MockWeatherRemoteDataSource extends _i1.Mock
  ...
  @override
  _i6.Future<_i3.WeatherModel> getWeather(String? city) => (super.noSuchMethod(
        Invocation.method(
          #getWeather,
          [city],
        ),
